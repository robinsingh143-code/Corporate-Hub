...
const Signin = () => {
  ...
  <div className="bg-gray-100 flex rounded-2xl shadow-lg max-w-3xl p-5 items-center">
    <div className="md:w-1/2 m-5">
      ...
      <form onSubmit={signinFrom.handleSubmit} action="" className="flex flex-col gap-4">
        {signinFrom.errors.email && signinFrom.touched.email ? (
          <div className='text-red-500 text-sm'>
            {signinFrom.errors.email}</div>
        ):null }
        <input
          onChange={signinFrom.handleChange}
          value={signinFrom.values.email}
        ...
        <div className="relative">
          {signinFrom.errors.password && signinFrom.touched.password ? (
            <div className='text-red-500 text-sm'>
             {signinFrom.errors.password}
            </div>
          ):null }
          <input
            onChange={signinFrom.handleChange}
            values={signinFrom.values.password}
