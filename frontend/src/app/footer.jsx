...
const Footer = () => {
  return (
    <>
  {/* ========== FOOTER ========== */}
  <footer className="mt-auto w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto text-white bg-blue-900">
    {/* Grid */}
    <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6 mb-10">
      <div className="col-span-full hidden lg:col-span-1 lg:block">
        <a
          className="flex-none font-semibold text-2xl focus:outline-none focus:opacity-80 "
          href="#"
          aria-label="Brand"
        >
          CORPORATE HUB
        ...
        Step into Success: Your Trusted Trio of CA, CS, and CMA Professionals, Committed to Your Business Success
        </p>
         ...
         <div className="space-x-4 mt-2">
            <a
              className="inline-block text-blue-800 border rounded-lg p-1 bg-white hover:bg-blue-700 hover:text-white"
              href="#"
            >
              <svg
            ...
            <a
              className="inline-block text-gray-700 border rounded-lg p-1  hover:text-white bg-white hover:bg-gray-700"
              href="#"
            >
              <svg
                className="shrink-0 size-4"
